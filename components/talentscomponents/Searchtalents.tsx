  ...
  return (
    <div className="pt-5">
      <div className="flex justify-between">
        <p className="text-sm text-[#888888] font-semibold">Explore Great African Talents in Blockchain developments</p>
      ...
      <div className="flex space-x-2 mt-5">
        <div className="relative w-full ">
          ...
          <input
            ...
            id="links"
            type="text"
            placeholder="Search for talents that best suit your projects..."
          />
        </div>
